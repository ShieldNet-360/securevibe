...
func TestResolveReleaseAssetURL(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			tag:  "latest",
			want: "https://github.com/shieldnet-360/securevibe/releases/latest/download/osv-cache.tar.gz",
		},
		{
			name: "specific tag uses /releases/download/<tag>/",
			tag:  "v0.1.1",
			want: "https://github.com/shieldnet-360/securevibe/releases/download/v0.1.1/osv-cache.tar.gz",
		},
		{
