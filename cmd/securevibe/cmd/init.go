...
import (
	...
	"github.com/shieldnet-360/securevibe/cmd/securevibe/internal/compiler"
	"github.com/shieldnet-360/securevibe/cmd/securevibe/internal/scheduler"
...
func maybeOfferScheduler(stdin io.Reader, out io.Writer) {
	...
	fmt.Fprintln(out, "scheduled update installed; run `securevibe dev scheduler status` to inspect")
}
