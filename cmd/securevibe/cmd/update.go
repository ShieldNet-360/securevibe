...
const DefaultUpdateSource = "https://github.com/shieldnet-360/securevibe/releases/latest/download/skills-library-data.tar.gz"
...
// regenerateAfterUpdate runs the same logic as `securevibe dev regenerate` so
