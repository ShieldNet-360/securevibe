#!/usr/bin/env node
// Smoke test for @shieldnet360/secure-code-skill:
...
//      `claude mcp add SecureVibe -- npx -y @shieldnet360/secure-code-mcp` fallback
//
...
async function main() {
  ...
  if (!text.includes('claude mcp add SecureVibe -- npx -y @shieldnet360/secure-code-mcp')) {
