...
// CLI for @shieldnet360/secure-code-skill — a tiny, binary-free installer:
//
...
// lives in @shieldnet360/secure-code-mcp and is fetched by npx on demand.

const path = require('node:path');
const fs = require('node:fs');
const { spawnSync } = require('node:child_process');

const MCP_PKG = '@shieldnet360/secure-code-mcp';
const PKG = '@shieldnet360/secure-code-skill';
