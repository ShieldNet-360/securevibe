# @shieldnet360/secure-code-skill
...
```sh
npx @shieldnet360/secure-code-skill init                    # Claude Code (default)
npx @shieldnet360/secure-code-skill init --tool cursor      # Cursor
npx @shieldnet360/secure-code-skill init ./app --tool copilot
```
...
# runs: claude mcp add secure-code -- npx -y @shieldnet360/secure-code-mcp
```

`connect-mcp` is generic — it can register **any** MCP server:

```sh
npx @shieldnet360/secure-code-skill connect-mcp semgrep -- npx -y @semgrep/mcp
npx @shieldnet360/secure-code-skill connect-mcp --user    # user (global) scope
```
...
- **`@shieldnet360/secure-code-skill`** (this) — the skills + a thin connector.
  Binary-free.
- **`@shieldnet360/secure-code-mcp`** — the MCP engine (Go binary + data),
...
Apache-2.0. See the [repository](https://github.com/shieldnet-360/securevibe).
