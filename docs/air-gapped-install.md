...
**SecureVibe** is designed to operate without any network access once the
...
> the project's brand changed to **SecureVibe**.
...
curl -L -o skills-check \
  https://github.com/shieldnet-360/securevibe/releases/latest/download/skills-check-linux-amd64
curl -L -o checksums.txt \
  https://github.com/shieldnet-360/securevibe/releases/latest/download/checksums-linux-amd64.txt

# Library payload (manifest + skills + vulnerabilities + dictionaries + dist)
curl -L -o skills-library-data.tar.gz \
  https://github.com/shieldnet-360/securevibe/releases/latest/download/skills-library-data.tar.gz
```
...
[`SIGNING.md`](https://github.com/shieldnet-360/securevibe/blob/main/SIGNING.md) for the public key rotation policy and the
