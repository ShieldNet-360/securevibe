...
| MCP server | `skills-mcp` | Exposes **16 tools** over stdio; the assistant calls them on demand for live, deterministic lookups | `claude mcp add securevibe -- npx -y @shieldnet360/secure-code-mcp` |
