...
The tap formula lives at [`packaging/homebrew/skills-check.rb`](https://github.com/shieldnet-360/securevibe/blob/main/packaging/homebrew/skills-check.rb).
...
[`SIGNING.md`](https://github.com/shieldnet-360/securevibe/blob/main/SIGNING.md) and
