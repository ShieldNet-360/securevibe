...
#
# This file is the canonical source for the shieldnet-360/tap/skills-check formula.
...
class SkillsCheck < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/shieldnet-360/securevibe/releases/download/v#{version}/skills-check-darwin-arm64"
      sha256 "REPLACE_WITH_DARWIN_ARM64_SHA256"
    end
    on_intel do
      url "https://github.com/shieldnet-360/securevibe/releases/download/v#{version}/skills-check-darwin-amd64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/shieldnet-360/securevibe/releases/download/v#{version}/skills-check-linux-arm64"
      sha256 "REPLACE_WITH_LINUX_ARM64_SHA256"
    end
    on_intel do
      url "https://github.com/shieldnet-360/securevibe/releases/download/v#{version}/skills-check-linux-amd64"
