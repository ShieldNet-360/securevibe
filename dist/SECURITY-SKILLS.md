...
Contains 30 security skills compiled at the compact budget tier.
...
## Electron Desktop Security (`electron-security`)

_Harden Electron apps: renderer trust boundary (nodeIntegration, contextIsolation, sandbox), contextBridge/IPC allowlists, shell.openExternal, navigation guards, deep-link auth, safeStorage_
...
## LLM Application Security (`llm-app-security`)

_Securing an app feature that calls an LLM with prompts: prompt injection (direct & indirect), prompt-construction boundaries, RAG context segregation, output handling, system-prompt & secret leakage, tool allowlists, cost limits_
...
## ML Model Security (`ml-security`)

_Model artifact loading (pickle vs safetensors), model & data poisoning, PII in training data, secrets in notebooks, model provenance / lineage_
...
- **@solana-labs/ancor** (npm, critical) — Part of the JFrog-disclosed 'Solana FakeFix' campaign (2026-06-11): ~25 npm/PyPI packages impersonating Solana developer tooling (@solana/web3.js, @solana/spl-token) and luring developers with fake 'stable/fixed/patched/LTS' builds. On install/import it steals Solana keypairs (~/.config/solana/id.json), SSH keys (~/.ssh/id_rsa), AWS credentials (~/.aws/credentials), source-control tokens, and .env secrets (vars named KEY/SECRET/MNEMONIC/TOKEN).
- **@solana-labs/etherjs** (npm, critical) — Part of the JFrog-disclosed 'Solana FakeFix' campaign (2026-06-11): ~25 npm/PyPI packages impersonating Solana developer tooling (@solana/web3.js, @solana/spl-token) and luring developers with fake 'stable/fixed/patched/LTS' builds. On install/import it steals Solana keypairs (~/.config/solana/id.json), SSH keys (~/.ssh/id_rsa), AWS credentials (~/.aws/credentials), source-control tokens, and .env secrets (vars named KEY/SECRET/MNEMONIC/TOKEN).
- **@solana-labs/spl-toke** (npm, critical) — Part of the JFrog-disclosed 'Solana FakeFix' campaign (2026-06-11): ~25 npm/PyPI packages impersonating Solana developer tooling (@solana/web3.js, @solana/spl-token) and luring developers with fake 'stable/fixed/patched/LTS' builds. On install/import it steals Solana keypairs (~/.config/solana/id.json), SSH keys (~/.ssh/id_rsa), AWS credentials (~/.aws/credentials), source-control tokens, and .env secrets (vars named KEY/SECRET/MNEMONIC/TOKEN).
- **@solana-labs/web3-js** (npm, critical) — Part of the JFrog-disclosed 'Solana FakeFix' campaign (2026-06-11): ~25 npm/PyPI packages impersonating Solana developer tooling (@solana/web3.js, @solana/spl-token) and luring developers with fake 'stable/fixed/patched/LTS' builds. On install/import it steals Solana keypairs (~/.config/solana/id.json), SSH keys (~/.ssh/id_rsa), AWS credentials (~/.aws/credentials), source-control tokens, and .env secrets (vars named KEY/SECRET/MNEMONIC/TOKEN).
- **@solana-labs/web3.js** (npm, critical) — Part of the JFrog-disclosed 'Solana FakeFix' campaign (2026-06-11): ~25 npm/PyPI packages impersonating Solana developer tooling (@solana/web3.js, @solana/spl-token) and luring developers with fake 'stable/fixed/patched/LTS' builds. On install/import it steals Solana keypairs (~/.config/solana/id.json), SSH keys (~/.ssh/id_rsa), AWS credentials (~/.aws/credentials), source-control tokens, and .env secrets (vars named KEY/SECRET/MNEMONIC/TOKEN).
- **@solana-labs/web3js** (npm, critical) — Part of the JFrog-disclosed 'Solana FakeFix' campaign (2026-06-11): ~25 npm/PyPI packages impersonating Solana developer tooling (@solana/web3.js, @solana/spl-token) and luring developers with fake 'stable/fixed/patched/LTS' builds. On install/import it steals Solana keypairs (~/.config/solana/id.json), SSH keys (~/.ssh/id_rsa), AWS credentials (~/.aws/credentials), source-control tokens, and .env secrets (vars named KEY/SECRET/MNEMONIC/TOKEN).
- **atomic-lockfile** (npm, critical) — Malicious npm package installed by the 'Atomic Arch' campaign (Sonatype, 2026-06-11), which hijacked ~1,500 orphaned Arch User Repository (AUR) projects and modified their PKGBUILDs to install this package at build time. Rootkit-like credential harvester targeting SSH artifacts, HashiCorp Vault tokens, browser cookies and collaboration-app data stores.
- **js-digest** (npm, critical) — Malicious npm package installed by the 'Atomic Arch' campaign (Sonatype, 2026-06-11), which hijacked ~1,500 orphaned Arch User Repository (AUR) projects and modified their PKGBUILDs to install this package at build time. Rootkit-like credential harvester targeting SSH artifacts, HashiCorp Vault tokens, browser cookies and collaboration-app data stores.
